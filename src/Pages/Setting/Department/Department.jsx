...
const Department = () => {
  ...
  return (
    <div className="lead-status-container mt-5">
        <BackButton/>
      <h2 className='bg-white p-2 border border-gray border-2 rounded mt-2'>Department</h2>
      

      {/* Add New Status */}
      <div className="addLeadscontainer add-status p-2 mb-2">
        <h4 className='addLeadsinput border border-black p-2 mb-2 text-white '>Add New Department</h4>
        <input
          type="text"
          value={newStatus}
