...
import { GetAllImage, UploadImag, UploadPolicyUrl } from '../../../Redux/Services/apiServer/ApiServer';
import DeleteButton from '../../../Components/Button/DeleteButton/DeleteButton'
import UploadPolicy from '../UploadPolicy/UploadPolicy';
export default function UploadImage() {
    ...
    const handleImageDelete = async (imageId) => {
        try {
            ...
            const deleteUrl = `http://192.168.1.227:5118/api/Image/DeleteById?id=${imageId}`;
